...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `50.6µs` | `67.7µs` |
| [Day 2](./src/bin/02.rs) | `1.9µs` | `25.1µs` |
| [Day 3](./src/bin/03.rs) | `70.2µs` | `104.2µs` |
| [Day 4](./src/bin/04.rs) | `1.5ms` | `32.1ms` |
| [Day 5](./src/bin/05.rs) | `115.5µs` | `33.6µs` |
| [Day 6](./src/bin/06.rs) | `73.3µs` | `2.3ms` |
| [Day 7](./src/bin/07.rs) | `47.1µs` | `46.1µs` |
